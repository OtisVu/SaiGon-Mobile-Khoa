...
<div id="preloder">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <div class="header__top__left" style="margin-left: 60px;margin-top: 5px; height: 50px;">                       
                            <ul>
    ...
    <section class="hero">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero__item set-bg" data-setbg="img/chinhsach.png">
                        <div class="hero__text">
                            <span>SALE 50%</span>
                            <h2>ACER<br>CHÍNH HÃNG 100%</h2>
