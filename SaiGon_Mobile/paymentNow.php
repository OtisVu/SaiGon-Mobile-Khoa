   ...
   <header class="header">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="hero__search" style="margin-top: 40px;margin-bottom: 30px;margin-left: 300px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <form method="POST" action="thongtinsanpham.php">
                                    <input type="hidden" name="order_id" value="<?php echo $order_id; ?>">
                                    <!-- Bạn có thể thêm các input hidden khác nếu cần thiết -->
