...
$con = mysqli_connect("localhost","Khoa","123456","saigon_mobile") or die("Can not connect to MySQL");
            ...
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" method="post">
                    ...
                    <div class="wrap-input100">
                        <input class="input100" type="text" name="check" id="check" value="<?php echo htmlspecialchars($emailDefault); ?>"
