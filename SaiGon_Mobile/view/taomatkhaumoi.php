        ...
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="login100-pic js-tilt" data-tilt>
                    <img src="../img/admin.png" alt="IMG" style="width: 500px;margin-left: 370px;margin-bottom: 100px;">
                </div>

                <form class="login100-form validate-form" method="post" style="margin-left: 500px;" >
                    <span class="login100-form-title1" style="margin-left: 40px;">
                        Quên mật khẩu 
                    </span>
                    ...
                    ?>
                    <div class="container-login100-form-btn1" style="margin-left: 50px;margin-top: 5px;">
